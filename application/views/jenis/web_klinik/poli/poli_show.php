<div class="card">
    ...
    <div class="card-body">
        <form action="?page=poli-show" method="POST">
        ...
        <!-- <div class="col-md-12"> -->
        <a href="?page=poli-add" class="btn btn-primary mb-2">Tambah Data</a>
        <a href="../poli/poli_print.php" target="_blank" class="btn btn-success mb-2">Cetak Data</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" href="?page=poli-edit&id=<?php echo $data['id']; ?>">Edit</a>
                                <a class="btn btn-sm btn-danger" href="../poli/poli_delete.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a>
                            </td>
                        </tr>
                    <?php
                        $no++;
        ...
        <nav class="mb-5">
            <ul class="pagination justify-content-end">
                ...
                if ($page == 1) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=polishow&halaman=1">First</a></li>';
                    echo '<li class="page-item"><a class="page-link" href="?page=poli-show&halaman='
                        . $link_prev . '" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
                }
                for ($i = $start_number; $i <= $end_number; $i++) {
                    $link_active = ($page == $i) ? ' active' : '';
                    echo '<li class="page-item ' . $link_active . '"><a class="page-link" href="?page=poli-show&halaman=' . $i . '">' . $i . '</a></li>';
                }
                if ($page == $jumlah_page) {
