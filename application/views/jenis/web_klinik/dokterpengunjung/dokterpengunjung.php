<div class="card">
    ...
    <div class="card-body">
        <form action="?page=dokterpengunjung-show" method="POST">
        ...
        <nav class="mb-5">
            <ul class="pagination justify-content-end">
                ...
                if ($page == 1) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=dokterpengunjungshow&halaman=1">First</a></li>';
                    echo '<li class="page-item"><a class="page-link" href="?page=dokterpengunjung-show&halaman='
                        . $link_prev . '" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
                }
                for ($i = $start_number; $i <= $end_number; $i++) {
                    $link_active = ($page == $i) ? ' active' : '';
                    echo '<li class="page-item ' . $link_active . '"><a class="page-link" href="?page=dokterpengunjung-show&halaman=' . $i . '">' . $i . '</a></li>';
                }
                if ($page == $jumlah_page) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=dokterpengunjungs-show&halaman='
